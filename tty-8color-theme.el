...
;; *****************************************************************************************
   ...
   `(magit-dimmed                     ((t (:foreground ,foreground))))
   '(corfu-default                    ((t (:foreground "cyan" :background "blue"))))
   '(rainbow-delimiters-base-face     ((t (:foreground "#00ff00" :weight bold))))
   '(rainbow-delimiters-depth-1-face  ((t (:foreground "#ffffff" :weight bold))))
   '(rainbow-delimiters-depth-2-face  ((t (:foreground "#ffff00" :weight bold))))
   '(rainbow-delimiters-depth-3-face  ((t (:foreground "#00ff00" :weight bold))))
   '(rainbow-delimiters-depth-4-face  ((t (:foreground "#00ffff" :weight bold))))
   '(rainbow-delimiters-depth-5-face  ((t (:foreground "#0000ff" :weight bold))))
   '(rainbow-delimiters-depth-6-face  ((t (:foreground "#ff00ff" :weight bold))))
